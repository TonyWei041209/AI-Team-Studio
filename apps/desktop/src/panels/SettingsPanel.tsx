...
// Roles that support real model configuration (planner, architect, builder, qa, security_reviewer, reviewer)
const CONFIGURABLE_ROLES = ["planner", "architect", "builder", "qa", "security_reviewer", "reviewer"] as const;
