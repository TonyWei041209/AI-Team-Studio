...
// Roles that support real model configuration (planner, architect, builder, qa, security_reviewer, reviewer, documentation)
const CONFIGURABLE_ROLES = ["planner", "architect", "builder", "qa", "security_reviewer", "reviewer", "documentation"] as const;
